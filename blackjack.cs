...
public class Card
{
    ...
    // Method to get the card's value in Blackjack
    public int GetValue()
    {
...
public class Deck
{
    ...
    // Constructor to initialize a deck with 52 cards
    public Deck()
    {
        cards = GenerateDeck();
    }
...
// Game class to manage the flow of the Blackjack game
public class Game
{
    private Deck deck;
    ...
    public void StartGame()
    {
        ...
        // Check for immediate win conditions (Blackjack)
